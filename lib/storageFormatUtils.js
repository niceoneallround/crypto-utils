...
//
// Create a representation of the encrypted data that has the following properties
// *has enough information such that the if one has access to encryption key within AWS.KMS one can decrypt
